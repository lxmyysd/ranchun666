local OrionLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/XiaoYunCN/LOL/main/Orion.lua", true))()
 local Window = OrionLib:MakeWindow({Name = "江脚本", HidePremium = false, SaveConfig = false, ConfigFolder = "rbxassetid://6026568198"}) 
...
LOL:AddLabel("作者:小徐Cynic")
LOL:AddLabel("QQ:3253549307")
LOL:AddLabel("副作者:江暖阳")
LOL:AddLabel("QQ:3674245781")
LOL:AddParagraph("江脚本群聊","群号1023991438")
